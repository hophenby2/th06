...
function BALL:init()
	...
	LoadImageFromFile('orange',	'THlib/background/ball/rectangle/05.png')
	LoadImageFromFile('yellow',	'THlib/background/ball/rectangle/04.png')
	LoadImageFromFile('blue',	'THlib/background/ball/rectangle/03.png')
	LoadImageFromFile('green',	'THlib/background/ball/rectangle/02.png')
	LoadImageFromFile('white',	'THlib/background/ball/rectangle/01.png')
...
function BALL:frame()
	...
	if rend_R<=15 and self.timer>120 then
		rend_R=rend_R+0.05
	end
