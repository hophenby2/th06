...
function ecl_Boss(self)
    ...
    -- +60:
    -- unsupported ins_419()
    SetV2(self, 112.0, ecl_rad(0.0), true, false)
...
function ecl_Boss2(self)
    ...
    ecl_var[-9949] = 0
    ecl_var[-9948] = 0
    SetV2(self, 0.0, ecl_rad(0.0), true, false)
    task.New(self, function() SetV2(self, 0.0, ecl_rad(0.0), true, false); task._Wait(0) end)
...
function ecl_Boss2_at1(self)
    ...
    -- laserShape id=0 length=512.0 width=16.0
    -- laserTiming id=0 warn=60 active=60
    ...
    -- etAngle et=0 angle=ecl_rad(v_A) step=ecl_rad(0.0)
    ecl_laser(0, self.x, self.y, 0, 512.0, 16.0, 60, 16, 60, 15, "line")
    -- etOffset et=0 x=114.0 y=54.0
    v_B = ecl_var[-9997] + (114)
    v_C = ecl_var[-9996] + (54)
    -- unsupported ins_520(%A, %B, %C)
...
function ecl_Boss3(self)
    ...
    task._Wait(60)
    -- visual/helper ins_416(28)
    SetV2(self, 96.0, ecl_rad(0.0), true, false)
    -- visual/helper ins_258(2)
    -- visual/helper ins_262(0, 0)
    -- visual/helper ins_263(0, 119)
    -- visual/helper ins_416(31)
...
function ecl_BossCard1(self)
    ...
    ecl_sync_self(self)
    SetV2(self, 128.0, ecl_rad(0.0), true, false)
    -- visual/helper ins_262(0, 0)
    -- +60:
    -- visual/helper ins_263(0, 119)
    task._Wait(60)
...
function ecl_BossCard2_at2(self)
    ...
    -- etSpeed et=0 speed=8.0 step=8.0
    -- laserShape id=0 length=512.0 width=16.0
    -- laserTiming id=0 warn=60 active=30
    -- unsupported ins_508(0, 19, -1)
    v_A = ecl_var[-9989]
    i_D = 16
    for _ecl_loop = 1, math.max(0, math.floor(i_D)) do
        -- etAngle et=0 angle=ecl_rad(v_A) step=ecl_rad(0.0)
        ecl_laser(0, self.x, self.y, 0, 512.0, 16.0, 60, 16, 30, 15, "line")
        v_A = v_A + 0.392699
    end
    do return end
end
...
function ecl_BossCard3_at2(self)
    ...
    -- laserShape id=0 length=-1.0 width=16.0
    -- laserTiming id=0 warn=32 active=-1
    -- unsupported ins_508(0, 19, -1)
    -- etEx et=0 params preserved
    -- etEx et=0 params preserved
    -- etEx et=0 params preserved
    ...
    for _ecl_loop = 1, math.max(0, math.floor(i_F)) do
        ...
        for _ecl_loop = 1, math.max(0, math.floor(i_G)) do
            ...
            -- etOffsetAbs et=0 x=v_B y=v_C
            -- etAngle et=0 angle=ecl_rad(v_A) step=ecl_rad(0.0)
            ecl_laser(0, self.x, self.y, 0, -1.0, 16.0, 32, -1, -1, -1, "curve")
...
function ecl_BossCard6_atLine(self)
    ...
    task._Wait(14)
    SetV2(self, ecl_var[-9980], ecl_rad(ecl_var[-9981]), true, false)
