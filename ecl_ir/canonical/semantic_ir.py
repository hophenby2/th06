...
INVARIANT_ARG_LAYOUTS: dict[str, tuple[str, ...]] = {
    ...
    "movement.circle.set": ("theta", "angular_speed", "radius", "radius_delta"),
    "movement.circle.tween": ("duration", "interpolation", "angular_speed", "radius", "radius_delta"),
    "movement.circle_rel.set": ("theta", "angular_speed", "radius", "radius_delta"),
    "movement.circle_rel.tween": ("duration", "interpolation", "angular_speed", "radius", "radius_delta"),
    "movement.ellipse.set": ("theta", "angular_speed", "radius", "radius_delta", "ellipse_angle", "ellipse_ratio"),
    "movement.ellipse.tween": ("duration", "interpolation", "angular_speed", "radius", "radius_delta", "ellipse_angle", "ellipse_ratio"),
    "movement.ellipse_rel.set": ("theta", "angular_speed", "radius", "radius_delta", "ellipse_angle", "ellipse_ratio"),
    "movement.ellipse_rel.tween": ("duration", "interpolation", "angular_speed", "radius", "radius_delta", "ellipse_angle", "ellipse_ratio"),
    "movement.bezier": ("duration", "x1", "y1", "x2", "y2", "x3", "y3"),
    "movement.bezier_rel": ("duration", "x1", "y1", "x2", "y2", "x3", "y3"),
    "movement.move_vel_nm_time": ("duration", "interpolation", "angle", "speed"),
    "movement.move_angle_time": ("duration", "interpolation", "angle"),
    "movement.move_speed_time": ("duration", "interpolation", "speed"),
    "movement.move_enm_rel": ("entity_id",),
    "unit.special_collision_flag": ("enabled",),
    "unit.kill_rate": ("weight",),
    "unit.spirit_drop_decay_frames": ("frames",),
    "unit.spirit_drop_max_count": ("count",),
    "anm.select": ("resource_bank",),
    "anm.set_sprite": ("slot", "script"),
    "anm.set_main": ("slot", "script"),
    "anm.play": ("resource_bank", "script"),
    "anm.play_abs": ("resource_bank", "script"),
    "anm.play_high": ("resource_bank", "script"),
    "anm.play_rotate": ("resource_bank", "script", "angle"),
    "anm.play_pos": ("resource_bank", "script", "x", "y", "z"),
    "anm.selected_play": ("script",),
    "anm.switch": ("slot", "switch"),
    "anm.rotate": ("slot", "angle"),
    "anm.move": ("slot", "x", "y"),
    "anm.color": ("slot", "red", "green", "blue"),
    "anm.color_time": ("slot", "duration", "interpolation", "red", "green", "blue"),
    "anm.alpha": ("slot", "alpha"),
    "anm.alpha_time": ("slot", "duration", "interpolation", "alpha"),
    "anm.alpha2": ("slot", "alpha"),
    "anm.alpha2_time": ("slot", "duration", "interpolation", "alpha"),
    "anm.scale": ("slot", "x", "y"),
    "anm.scale_time": ("slot", "duration", "interpolation", "x", "y"),
    "anm.scale2": ("slot", "x", "y"),
    "anm.layer": ("slot", "layer"),
    "anm.blend_mode": ("slot", "blend_mode"),
    "anm.on_et": ("et_id", "slot"),
    "enemy.death_anm": ("resource_bank", "script"),
    "enemy.create": ("routine", "x", "y", "health", "score_reward", "item_drop"),
    "enemy.create_abs": ("routine", "x", "y", "health", "score_reward", "item_drop"),
    "enemy.create_mirror": ("routine", "x", "y", "health", "score_reward", "item_drop"),
    "enemy.create_abs_mirror": ("routine", "x", "y", "health", "score_reward", "item_drop"),
    "enemy.create_func": ("routine", "x", "y", "health", "score_reward", "item_drop"),
    "enemy.create_abs_func": ("routine", "x", "y", "health", "score_reward", "item_drop"),
    "enemy.create_mirror_func": ("routine", "x", "y", "health", "score_reward", "item_drop"),
    "enemy.create_abs_mirror_func": ("routine", "x", "y", "health", "score_reward", "item_drop"),
    "enemy.create_maple": ("routine", "x", "y", "health", "score_reward", "item_drop"),
...
SOURCE_FORMS: tuple[SourceForm, ...] = (
    SourceForm(
        "enemy.create",
        "th10_th11",
        ("routine", "x", "y", "legacy_parameter", "health", "score_reward", "item_drop"),
    ),
    SourceForm(
        "enemy.create",
        "th12",
