...
INVARIANT_ARG_LAYOUTS: dict[str, tuple[str, ...]] = {
    ...
    "enemy.create_mirror": ("routine", "x", "y", "health", "main_drop", "score"),
    "enemy.create_abs_mirror": ("routine", "x", "y", "health", "main_drop", "score"),
    "enemy.create_func": ("routine", "x", "y", "health", "main_drop", "score"),
    "enemy.create_abs_func": ("routine", "x", "y", "health", "main_drop", "score"),
    "enemy.create_mirror_func": ("routine", "x", "y", "health", "main_drop", "score"),
    "enemy.create_abs_mirror_func": ("routine", "x", "y", "health", "main_drop", "score"),
    "enemy.create_maple": ("routine", "x", "y", "health", "main_drop", "score"),
